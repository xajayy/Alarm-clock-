...
window.addEventListener("DOMContentLoaded", (event) => {
  // Calling the function to add hours, minutes, and seconds in Dropdown Menu
 ...
 // Updating the current time every 1000ms (1s) and fetching alarm
...
// Function to create dropdown menu for hours, minutes, and seconds
...
// Function to Converting time to 24 hour format
function convertToTime(hour, minute, second, amPm) {
  return `${parseInt(hour)}:${minute}:${second} ${amPm}`;
}


// Function to set alarm and check for the alarm
